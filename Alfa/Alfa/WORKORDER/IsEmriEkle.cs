...
namespace Alfa.WORKORDER
{
    public partial class IsEmriEkle : Form
    {
        ...
        private void IsEmriEkle_Load_1(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'alfaPlastikDataSet2.MAINTAINTYPE' table. You can move, or remove it, as needed.
            this.mAINTAINTYPETableAdapter.Fill(this.alfaPlastikDataSet2.MAINTAINTYPE);
            this.wAREHOUSETableAdapter.Fill(this.alfaPlastikDataSet2.WAREHOUSE);
            this.mOLDTableAdapter.Fill(this.alfaPlastikDataSet2.MOLD);
            ...
            lblTarih.Text = DateTime.Now.ToString();//Anlık tarih gelir.
            textBox_Kullanici.Text = GirisSayfasi.aktif.NAME;//GİRİŞ YAPAN KULLANICIYI TEXTBOX'A YAZAR.
            WindowState = FormWindowState.Maximized;//TAM EKRANDA GÖRÜNTÜLEME

            #region TOOLTİP
            ToolTip tool = new ToolTip();
            tool.SetToolTip(buttoncikis, "ÇIKIŞ");//MOUSE GELDİĞİNDE ÇIKIŞ YAZAR.
            tool.SetToolTip(button9, "KAYDET");//MOUSE GELDİĞİNDE KAYDET YAZAR.
            #endregion
        ...
        {
            //ANLIK TARİHİ TARİH İLE SAAT OLARAK TEXTBOXLARA TEXT OLARAK YAZAR.
        ...
        private void button_TALEP_Click_1(object sender, EventArgs e)//TALEP AŞAMASINI GETİRME.
        {
            ucIsEmir1.BringToFront();
        ...
        private void button_PLANLAMA_Click_1(object sender, EventArgs e)//PLANLAMA AŞAMASINI GETİRME.
        {
        ...
        public void opelist()
        {
            ...
            {
                V_WRKORD_GRID wrk = managerV_WRKORD_GRID.Find(x=>x.WRKORD_ID==id);
        ...
        private void button_PROSES_Click(object sender, EventArgs e) //PROSES AŞAMASINI GETİRME.
        {
        ...
        private void button5_Click(object sender, EventArgs e) //TAMAMLANMA AŞAMASINA GİDER.
        {
        ...
        public void IsEmri()
        {
            if (!string.IsNullOrEmpty(comboBox_BakimTipi.Text) && !string.IsNullOrEmpty(comboBox_Ka.Text) && !string.IsNullOrEmpty(comboBox_Kn.Text) && !string.IsNullOrEmpty(TBX_İsEmriNo.Text) && !string.IsNullOrEmpty(ucIsEmir1.comboBox1.Text) && !string.IsNullOrEmpty(ucIsEmir1.comboBox_Öncelik.Text) && !string.IsNullOrEmpty(ucIsEmir1.dateTimePicker3.Text) && !string.IsNullOrEmpty(ucIsEmir1.dateTimePicker2.Text) && !string.IsNullOrEmpty(ucIsEmir1.richTextBox_not.Text))
            {
                ...
                else
                {
                    ...
                    ucIsEmir1.label7.Text = w.WRKORD_INSERTDATE.ToString();//kayıt işlemi gerçekleştiğinde talep kısmının altında labelin içinde kayıt tarihi gelir.
        ...
        private void buttoncikis_Click_1(object sender, EventArgs e) //ÇIKIŞ BUTONU
        {
